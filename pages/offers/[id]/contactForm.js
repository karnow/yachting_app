              ...
              <div className="p-2 w-full">
                {!confirmation && (
                  <button
                    ...
                    className="disabled:opacity-50 flex mx-auto mb-4 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">
                ...
                <button
                  type="reset"
                  onClick={resetForm}
                  className="disabled:opacity-50 flex mx-auto mb-4 text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">
                  Reset form
                </button>
                {error && (
